...
import (
	...
	testv1 "autumn.io/nodepool/api/v1"
)
...
//+kubebuilder:rbac:groups=test.autumn.io,resources=nodepools,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=test.autumn.io,resources=nodepools/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=test.autumn.io,resources=nodepools/finalizers,verbs=update
