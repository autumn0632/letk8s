...
var keyReg = regexp.MustCompile(`^node-pool.autumn.io/*[a-zA-z0-9]*$`)
...
func (n *NodePoolSpec) ApplyNode(node corev1.Node) *corev1.Node {
	...
	node.Spec.Taints = append(taints, n.Taints...)
	return &node
